  ...
  <div id="add-blog">
    ...
    <form v-if="!submitted">
      ...
      <div id="checkboxes">
        ...
        <input type="checkbox" value="Artificial Intelligence" v-model="blog.categories">
      </div>
      <label>Author:</label>
...
export default {
  data() {
    return {
      ...
      authors: ["Harsh Jain", "Ram Sharma", "Aman Patidar"],
      submitted: false
    };
  },
  methods: {
    post: function() {
      this.$http
        .post("https://blogging-app-6a414.firebaseio.com/posts.json", this.blog)
        .then(function(data) {
          console.log(data);
          this.submitted = true;
        });
